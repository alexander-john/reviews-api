...
class CypherOperation extends ReadOperation_1.ReadOperation {
    ...
    transpile(context) {
        ...
        const authClauses = authPredicates.length
            ? [...authFilterSubqueries, new cypher_builder_1.default.With("*").where(cypher_builder_1.default.and(...authPredicates))]
            : [];
        ...
        const clause = cypher_builder_1.default.concat(matchClause, ...extraMatches, fieldSubqueries, ...authClauses, ret);
        return {
            clauses: [clause],
