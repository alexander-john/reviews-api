...
export declare const LIBRARY_DIRECTIVES: readonly [...("authentication" | "jwt" | "key" | "authorization" | "coalesce" | "customResolver" | "cypher" | "default" | "filterable" | "fulltext" | "id" | "jwtClaim" | "limit" | "mutation" | "plural" | "populatedBy" | "private" | "query" | "relayId" | "selectable" | "settable" | "subscription" | "timestamp" | "unique" | "vector" | "subscriptionsAuthorization")[], "alias", "relationship", "relationshipProperties", "declareRelationship", "node", "shareable"];
